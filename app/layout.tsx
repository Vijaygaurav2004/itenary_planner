...
export const metadata: Metadata = {
  title: "MindJourney - AI Travel Planner",
        ...
        <ThemeProvider attribute="class" defaultTheme="system" enableSystem disableTransitionOnChange>
          ...
          <div className="fixed inset-0 -z-10 overflow-hidden">
            <div className="absolute -inset-[10px] opacity-50">
              ...
              <div className="absolute bottom-1/3 right-1/3 w-96 h-96 bg-blue-600 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-6000"></div>
            </div>
            ...
            <div className="absolute inset-0 bg-[radial-gradient(circle_800px_at_100%_200px,rgba(120,119,198,0.1),transparent)]"></div>
          </div>
          ...
          <div className="relative z-10">
            ...
            <footer className="relative mt-20 border-t border-gray-200 dark:border-gray-800">
              <div className="absolute inset-x-0 -top-10 h-10 bg-gradient-to-b from-transparent to-white/5 dark:to-black/5"></div>
              <div className="container mx-auto px-6 py-12">
                <div className="flex flex-col md:flex-row justify-between items-center">
                  <div className="mb-6 md:mb-0">
                    <h2 className="text-2xl font-bold gradient-text">MindJourney</h2>
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">Reimagine your travel experience</p>
                  </div>
                ...
                <div className="mt-8 border-t border-gray-200 dark:border-gray-800 pt-8 md:flex md:items-center md:justify-between">
                  <div className="text-sm text-gray-500 dark:text-gray-400">
                    © {new Date().getFullYear()} MindJourney. All rights reserved.
                  </div>
